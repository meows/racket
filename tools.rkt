...
;                 (function (apply quad (map (curry * 1) '(1 -4 3))) #:width 1.4 #:color 'red   #:label "f(x) = 1(x² - 4x + 3)")
;                 (function (apply quad (map (curry * 2) '(1 -4 3))) #:width 1.4 #:color 'blue  #:label "g(x) = 2(x² - 4x + 3)")
;                 (function (apply quad (map (curry * 3) '(1 -4 3))) #:width 1.4 #:color 'brown #:label "h(x) = 3(x² - 4x + 3)")
;           )
...
;;; (parameterize ([plot-x-ticks (linear-ticks #:number 10)]
;;;         ;        [plot-y-ticks (linear-ticks #:number 10)]
;;;                )
;;;     (plot (list (axes #:x-ticks? true #:y-ticks? true)
;;;                 (tick-grid)
;;;                 (function (apply cubic (append (map (curry + 0) '(1 -12 44)) '(-48))) #:width 1.4 #:color 'red #:label "f(x*0.5)")
;;;                 (function (apply cubic (append (map (curry + -1) '(1 -12 44)) '(-48))) #:width 1.4 #:color 'blue #:label "f(x*0.5)")
;;;           )
